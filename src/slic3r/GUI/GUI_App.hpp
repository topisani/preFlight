...
// Fix for application initialization issue
...
public:
    ...
    bool check_and_save_current_preset_changes(const wxString &caption, const wxString &header,
                                               bool remember_choice = true,
                                               bool use_dont_save_insted_of_discard = false);
    void apply_keeped_preset_modifications();
    bool check_and_keep_current_preset_changes(const wxString &caption, const wxString &header, int action_buttons,
    ...
    // Translate the language code to a supported translation code. Defaults to "en_US".
    wxString current_language_code_safe() const;
    bool is_localized() const { return m_wxLocale->GetLocale() != "English"; }

    void open_preferences(const std::string &highlight_option = std::string(),
    ...
    bool open_browser_with_warning_dialog(const wxString &url, wxWindow *parent = nullptr,
    ...
    int GetSingleChoiceIndex(const wxString &message, const wxString &caption, const wxArrayString &choices,
    ...
    // URL download - preFlight gets system call to open preflight:// URL which should contain address of download
    ...
    void search_and_select_filaments(const std::string &material, bool avoid_abrasive, size_t extruder_index,
