...
///|/
#ifndef slic3r_GUI_preFlight_BackgroundSlicingProcess_hpp_
#define slic3r_GUI_preFlight_BackgroundSlicingProcess_hpp_
...
public:
    ...
    bool running() const
    {
        return m_state == STATE_STARTED || m_state == STATE_RUNNING || m_state == STATE_FINISHED ||
...
private:
    ...
    // Non-owned pointer to Print instance.
...
#endif /* slic3r_GUI_preFlight_BackgroundSlicingProcess_hpp_ */
