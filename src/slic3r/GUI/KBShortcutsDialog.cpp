...
KBShortcutsDialog::KBShortcutsDialog()
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY,
                wxString(wxGetApp().is_editor() ? SLIC3R_APP_NAME : GCODEVIEWER_APP_NAME) + " - " +
...
void KBShortcutsDialog::fill_shortcuts()
{
    ...
    {
        Shortcuts commands_shortcuts = {// File
                                        ...
                                        // View
                                        {ctrl + "E", L("Show/Hide object/instance labels")},
                                        {ctrl + "L", L("Show/Hide legend in preview")},
        // Configuration
#ifdef __APPLE__
                                        {ctrl + ",", L("Preferences")},
#else
...
#endif
                                        // Help
                                        {"F1", L("Show keyboard shortcuts list")}};
        ...
        m_full_shortcuts.push_back(
            {{_L("Gizmos"), _L("The following shortcuts are applicable when the specified gizmo is active")},
             gizmos_shortcuts});
    ...
    Shortcuts preview_shortcuts = {
        ...
        {ctrl + L("Any arrow"), L("Move slider 2x faster")},
        {std::string("Shift+") + L("Any arrow"), L("Move slider 4x faster")},
        {ctrl + "Shift+" + L("Any arrow"), L("Move slider 8x faster")},
    ...
    Shortcuts layers_slider_shortcuts = {
        ...
        {ctrl + L("Any arrow"), L("Move thumb 2x faster")},
        {std::string("Shift+") + L("Any arrow"), L("Move thumb 4x faster")},
        {ctrl + "Shift+" + L("Any arrow"), L("Move thumb 8x faster")},
    };

    m_full_shortcuts.push_back(
        {{_L("Vertical Slider"),
          _L("The following shortcuts are applicable in G-code preview when the vertical slider is active")},
    ...
    m_full_shortcuts.push_back(
        {{_L("Horizontal Slider"),
          _L("The following shortcuts are applicable in G-code preview when the horizontal slider is active")},
         sequential_slider_shortcuts});
}
