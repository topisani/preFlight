...
static std::vector<std::string> s_Preset_print_options{
    ...
    "solid_fill_pattern",
    "narrow_solid_infill_concentric",
...
static std::vector<std::string> s_Preset_filament_options{
    "filament_colour", "filament_diameter", "filament_type", "filament_soluble", "filament_abrasive", "filament_notes",
    ...
    "slowdown_below_layer_time", "min_print_speed", "custom_parameters_filament", "start_filament_gcode",
...
static std::vector<std::string> s_Preset_printer_options{
    ...
    "use_volumetric_e", "variable_layer_height", "prefer_clockwise_movements",
